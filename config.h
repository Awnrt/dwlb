...
static pixman_color_t active_bg_color = { .red = 0xb1b1, .green = 0x6262, .blue = 0x8686, .alpha = 0xffff, };
static pixman_color_t occupied_fg_color = { .red = 0xeeee, .green = 0xeeee, .blue = 0xeeee, .alpha = 0xffff, };
static pixman_color_t occupied_bg_color = { .red = 0xb1b1, .green = 0x6262, .blue = 0x8686, .alpha = 0xffff, };
...
static pixman_color_t middle_bg_color_selected = { .red = 0xb1b1, .green = 0x6262, .blue = 0x8686, .alpha = 0xffff, };
